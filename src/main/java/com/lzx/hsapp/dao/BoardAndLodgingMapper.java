...
public interface BoardAndLodgingMapper {
    ...
    @Insert("insert into board_and_lodging (id,trip_id,course_id,city,place,start_time,stop_time,create_time,modify_time) " +
            "values (#{id},#{tripId},#{courseId},#{city},#{place},#{startTime},#{stopTime},#{createTime},#{modifyTime})")
